...
def get_order():
    ...
    with open("stock.csv", "r") as data_file:
        ...
        for icecream in stock_data:
            if icecream != "" and icecream != "Ice Cream, Amount":
                ...
                icecream_to_amount.update({splitted_data[0]:splitted_data[1]})
    ...
    while not scoop.isdigit():
        print("Amount of scoop must be a positive integer. Please try again.")
        scoop = input("Enter amount of scoop: ")
    ...
    print("☑ Amount -> ☑ Flavor -> ☑ Size -> ☑ Topping -> ☐ Container")
    print("Container: ")
    for each_container, each_container_price in price_data["container"].items():
